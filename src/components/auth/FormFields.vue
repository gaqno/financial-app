<template>
  <div class="space-y-6">
    ...
    <div>
      ...
      <div v-if="isRegisterMode" class="text-xs text-gray-500 mt-1">Mínimo de 6 caracteres</div>
    </div>
    ...
    <div v-if="isRegisterMode">
      ...
      <input
        ...
        :disabled="isLoading"
      />
      <div v-if="passwordMismatch" class="text-xs text-red-600 mt-1">As senhas não coincidem</div>
    </div>
  </div>
</template>
