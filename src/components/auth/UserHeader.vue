<template>
  <div class="user-header bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-600 px-4 py-3 shadow-sm fixed top-0 left-0 right-0 w-full z-50 theme-transition">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
      ...
      <div class="flex items-center space-x-3">
        ...
        <!-- Notifications -->
        <NotificationBell v-if="showNotifications" :notifications="notifications"
          @mark-read="$emit('notification-read', $event)" @mark-all-read="$emit('notifications-read-all')"
