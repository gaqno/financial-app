<template>
  <Teleport to="body">
    <div v-if="hasToasts" class="toast-container">
      <TransitionGroup name="toast" tag="div" class="toast-wrapper" enter-active-class="toast-enter-active"
        leave-active-class="toast-leave-active" enter-from-class="toast-enter-from" leave-to-class="toast-leave-to">
        <div v-for="toast in toasts" :key="toast.id" class="toast" :class="getToastClasses(toast)"
