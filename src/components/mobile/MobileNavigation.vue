<template>
  ...
  <nav v-if="isMobile"
    ...
    <div class="grid grid-cols-5 h-16">
      ...
      <!-- Home/Dashboard -->
      <button @click="setActiveTab('dashboard')" :class="getNavItemClasses('dashboard')"
      ...
      <!-- Transactions -->
      <button @click="setActiveTab('transactions')" :class="getNavItemClasses('transactions')"
        class="flex flex-col items-center justify-center space-y-1 p-2">
      ...
      <!-- Analytics -->
      <button @click="setActiveTab('analytics')" :class="getNavItemClasses('analytics')"
        class="flex flex-col items-center justify-center space-y-1 p-2">
      ...
      <!-- Profile/Settings -->
      <button @click="setActiveTab('profile')" :class="getNavItemClasses('profile')"
        class="flex flex-col items-center justify-center space-y-1 p-2">
...
const pendingCount = computed(() =>
  financeStore.records.filter(r => r.Status === '❌').length
)
