    ...
    <div v-if="isOpen" class="fixed inset-0 z-50 bg-white dark:bg-slate-900">
      ...
      >
        <div class="flex items-center justify-between mb-2">
          ...
          <button @click="clearRecentSearches" class="text-sm text-blue-500 hover:text-blue-600">Limpar</button>
        </div>
        <div class="space-y-2">
          <button
      ...
      <div class="flex-1 overflow-y-auto">
        <div v-if="isSearching" class="flex items-center justify-center py-12">
          <div class="text-center">
            <div
              class="animate-spin w-8 h-8 border-2 border-blue-500 border-t-transparent rounded-full mx-auto mb-3"
            ></div>
            ...
            <div class="flex items-start justify-between mb-2">
              <div class="flex-1">
                <h3
                  ...
                  v-html="highlightSearchTerm(result.Descrição)"
                ></h3>
              ...
              <div class="text-right">
                <div :class="['text-lg font-bold', result.Valor < 0 ? 'text-red-600' : 'text-green-600']">
