<template>
  <section class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
    <div class="flex items-center justify-between cursor-pointer p-4 hover:bg-gray-50 transition-colors" @click="toggleImportSection">
    ...
    <div v-show="isExpanded" class="border-t border-gray-200">
      <div class="p-4 space-y-4">
        <!-- Upload Area -->
        <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-blue-300 transition-colors">
        <input
          ref="fileInputRef"
          type="file"
          accept=".csv"
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
          ...
          <div class="lg:hidden">
            <p class="text-xs text-blue-700 mb-2">
              Colunas necessárias: Data, Descrição, Valor, Tipo, Status
            </p>
          ...
          <div class="hidden lg:block">
            ...
            <div class="text-sm text-blue-700 space-y-1">
              <div><strong>Data:</strong> formato DD/MM ou YYYY-MM-DD (ex: 07/08)</div>
              <div><strong>Descrição:</strong> texto descritivo</div>
              <div><strong>Valor:</strong> formato brasileiro (ex: "R$ 1.500,00")</div>
              <div><strong>Tipo:</strong> "Receita" ou "Despesa"</div>
              <div><strong>Status:</strong> "❌" ou "✔️"</div>
              <div><strong>Categoria:</strong> opcional (detectada automaticamente)</div>
              <div><em class="text-blue-600">✨ Categoria detectada pela descrição</em></div>
            </div>
          </div>
          ...
          <div class="mt-3">
            <button
              ...
              class="text-blue-600 hover:text-blue-800 text-sm underline font-medium"
            >
