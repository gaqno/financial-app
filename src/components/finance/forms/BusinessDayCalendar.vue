<template>
  <div class="business-day-calendar">
    ...
    <div class="flex items-center justify-between mb-3">
      <h3 class="text-sm font-semibold text-gray-800">{{ monthName }} {{ year }}</h3>
    ...
    <div class="grid grid-cols-7 gap-1 text-xs">
      ...
      <div
        ...
        class="text-center py-1 rounded-md transition-colors"
        :class="getDayClasses(day)"
      >
        <span class="block">{{ day.dayNumber }}</span>
        <div v-if="day.businessDayNumber" class="text-xs text-blue-600 font-bold">{{ day.businessDayNumber }}º</div>
      </div>
    </div>
