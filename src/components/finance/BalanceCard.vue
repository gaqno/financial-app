<template>
  <div
    class="lg:hidden bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-800 transition-colors"
  >
    <div class="text-center">
      <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Saldo Atual</h2>
      ...
      <p class="text-sm text-gray-600 dark:text-gray-300 mt-2">{{ totalRecords }} transações registradas</p>
