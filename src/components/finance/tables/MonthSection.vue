<template>
  <div class="month-section">
    <!-- Month Header -->
    <div
      class="bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-800 transition-colors mb-2"
    >
      <div
        @click="toggleCollapse"
        class="flex items-center justify-between cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors rounded-lg p-2 -m-2"
      >
      ...
      <div>
        ...
        >
          <div v-if="!isCollapsed" class="month-expandable-content">
            <!-- Category Summary -->
            <div v-if="categorySummary.length > 0" class="mt-4 pt-3 border-t border-blue-200 dark:border-blue-700">
