<template>
  <div class="month-section">
    <!-- Month Header -->
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-800 transition-colors mb-2">
      <div @click="toggleCollapse" class="flex items-center justify-between cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors rounded-lg p-2 -m-2">
      ...
      >
        <div v-if="!isCollapsed" class="month-expandable-content">
          <!-- Category Summary -->
          <div v-if="categorySummary.length > 0"
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
              <div v-for="category in categorySummary" :key="category.name"
          ...
          <!-- Desktop Table -->
          <div
            class="hidden lg:block bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-800 transition-colors overflow-hidden mb-6 theme-transition mt-4">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-600">
              <thead class="bg-gray-50 dark:bg-gray-700">
                <tr>
                  <th @click="handleSort('Data')"
          ...
          <!-- Mobile Cards -->
          <div class="lg:hidden space-y-3 mb-6 mt-4">
...
<style scoped>
/* Smooth height transition for month section */
.month-section {
  transition: all 0.2s;
}
...
/* Ensure smooth transition for expandable content */
.month-expandable-content {
  transition: all 0.2s;
}
</style>
