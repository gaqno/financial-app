<template>
  <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
    ...
    <div @click="toggleCollapse"
      class="bg-gradient-to-r from-purple-50 to-indigo-50 border-b border-purple-200 p-4 cursor-pointer hover:from-purple-100 hover:to-indigo-100 transition-all duration-200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div class="bg-green-50 rounded-lg p-4 border border-green-200">
            <div class="flex items-center gap-2 mb-2">
              ...
              <span class="text-sm font-medium text-green-800">Receitas Médias</span>
            </div>
          ...
          <div class="bg-red-50 rounded-lg p-4 border border-red-200">
            <div class="flex items-center gap-2 mb-2">
              ...
              <span class="text-sm font-medium text-red-800">Despesas Médias</span>
            </div>
          ...
          <div class="bg-blue-50 rounded-lg p-4 border border-blue-200">
            <div class="flex items-center gap-2 mb-2">
              ...
              <span class="text-sm font-medium text-blue-800">Saldo Médio</span>
            </div>
            <div class="text-xl font-bold" :class="averageBalance < 0 ? 'text-red-700' : 'text-green-700'">
          ...
          <table class="w-full">
            <thead>
              <tr class="border-b border-gray-200">
                <th class="text-left py-2 px-3 text-sm font-medium text-gray-600">Mês</th>
                <th class="text-right py-2 px-3 text-sm font-medium text-gray-600">Receitas Proj.</th>
                <th class="text-right py-2 px-3 text-sm font-medium text-gray-600">Despesas Proj.</th>
                <th class="text-right py-2 px-3 text-sm font-medium text-gray-600">Saldo Mensal</th>
                <th class="text-right py-2 px-3 text-sm font-medium text-gray-600">Saldo Acumulado</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="month in yearlyProjection" :key="month.month" :class="[
                month.isActual ? 'bg-gray-50' : 'bg-purple-50/30',
                'border-b border-gray-100'
              ]">
                <td class="py-2 px-3 text-sm">
                  <div class="flex items-center gap-2">
                    <span class="font-medium">{{ month.monthName }}</span>
                    <span v-if="month.isActual" class="text-xs bg-gray-200 text-gray-700 px-1 rounded">
                      Real
                    </span>
                    <span v-else class="text-xs bg-purple-200 text-purple-700 px-1 rounded">
                      Projeção
                    </span>
                  </div>
                </td>
            ...
            <div v-for="category in categoryProjections" :key="category.name"
              ...
              <div class="space-y-1">
                <div class="flex justify-between text-sm">
                  <span class="text-gray-600">Mensal médio:</span>
                ...
                <div class="flex justify-between text-sm">
                  <span class="text-gray-600">Projeção anual:</span>
