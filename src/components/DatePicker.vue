<template>
  <div class="relative">
    ...
    <div v-else class="space-y-2">
      <select 
        v-model="businessDayMode.dayNumber" 
        @change="updateBusinessDay"
        :class="selectClass">
...
export default {
  ...
  props: {
    ...
    inputClass: {
      type: String,
      default: 'w-full border border-gray-300 p-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
    },
    selectClass: {
      type: String,
      default: 'w-full border border-gray-300 p-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
    ...
    toggleButtonClass: {
      type: String,
      default: 'absolute top-1 right-1 w-6 h-6 bg-blue-500 hover:bg-blue-600 text-white rounded-full text-xs flex items-center justify-center'
    },
    previewClass: {
      type: String,
      default: 'text-center'
