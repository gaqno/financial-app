  ...
  <div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-600">
      <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-600">
        ...
        <p class="text-sm text-gray-600 dark:text-slate-400 mt-1">Mantenha sua conta segura com uma senha forte</p>
      </div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-600">
      <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-600">
        ...
        <p class="text-sm text-gray-600 dark:text-slate-400 mt-1">Gerencie onde você está conectado</p>
      </div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-600">
      <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-600">
        ...
        <p class="text-sm text-gray-600 dark:text-slate-400 mt-1">Adicione uma camada extra de segurança à sua conta</p>
      </div>
    ...
    <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-6">
      <div class="flex items-start gap-3">
        ...
        <div>
          <h4 class="font-medium text-yellow-800 dark:text-yellow-200 mb-2">🐷 Dicas de Segurança do por.quinho</h4>
