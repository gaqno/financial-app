    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-600">
      ...
      <div class="p-6 space-y-4">
        ...
        <div>
          ...
          <div class="space-y-2">
            <div v-for="language in languageOptions" :key="language.code" @click="updateLanguage(language.code)"
              ...
              :class="{ 'border-pink-500 bg-pink-50 dark:bg-pink-900/20': currentLanguage?.code === language.code }">
        ...
        <div>
          ...
          <div class="space-y-2">
            <div v-for="currency in currencyOptions" :key="currency.code" @click="updateCurrency(currency.code)"
              class="flex items-center justify-between p-3 border border-gray-200 dark:border-slate-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors"
              :class="{ 'border-pink-500 bg-pink-50 dark:bg-pink-900/20': currentCurrency?.code === currency.code }">
              <div class="flex items-center gap-3">
                <span class="text-lg font-bold text-gray-600 dark:text-slate-400 w-8">{{ currency.symbol }}</span>
                <div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-600">
      ...
      <div class="p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div v-for="theme in themeOptions" :key="theme.value" @click="updateTheme(theme.value as any)"
            ...
            :class="{ 'border-pink-500 bg-pink-50 dark:bg-pink-900/20': currentTheme?.value === theme.value }">
      ...
      <div class="p-6 space-y-4">
        ...
        <div class="flex items-center justify-between">
          ...
          <label class="relative inline-flex items-center cursor-pointer">
            <input v-model="localNotifications.email" type="checkbox" class="sr-only peer"
        ...
        <div class="flex items-center justify-between">
          ...
          <label class="relative inline-flex items-center cursor-pointer">
            <input v-model="localNotifications.push" type="checkbox" class="sr-only peer"
              @change="updateNotifications" />
            <div
              class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-pink-300 dark:peer-focus:ring-pink-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-pink-600">
            </div>
        ...
        <div class="flex items-center justify-between">
          ...
          <label class="relative inline-flex items-center cursor-pointer">
            <input v-model="localNotifications.reports" type="checkbox" class="sr-only peer"
              @change="updateNotifications" />
            <div
              class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-pink-300 dark:peer-focus:ring-pink-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-pink-600">
            </div>
      ...
      <div class="p-6 space-y-4">
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-gray-500 dark:text-slate-400">Ajude a melhorar o por.quinho compartilhando dados
              anônimos de uso</p>
          </div>
          <label class="relative inline-flex items-center cursor-pointer">
