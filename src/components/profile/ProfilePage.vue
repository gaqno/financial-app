<template>
  <div
    ...
    <!-- Header -->
    <ProfileHeader :profile="profile" :is-editing="isEditing" @edit="startEditing" @save="updateProfile"
      @cancel="cancelEditing" @upload-avatar="uploadAvatar" />
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-show="activeSection === 'profile'">
        <ProfileEditor :profile="editingProfile" :is-editing="isEditing" :is-loading="isLoading"
          :has-changes="hasChanges" @update="updateEditingProfile" @save="updateProfile" @cancel="cancelEditing" />
      </div>
